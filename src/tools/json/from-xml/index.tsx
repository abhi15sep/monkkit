...
export default function XmlToJson({ toolMeta: _ }: ToolComponentProps) {
  ...
  return (
    <div className="flex flex-col gap-3 p-4">
      <div className="flex flex-wrap items-center gap-2">
        <Button size="sm" onClick={handleConvert} disabled={!input.trim()}>XML → JSON</Button>
      ...
      <SplitPane
        left={<CodeEditor value={input} onChange={resetInput} placeholder="Paste XML here…" height="420px" />}
        right={
