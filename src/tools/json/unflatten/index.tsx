...
export default function JsonUnflatten({ toolMeta: _ }: ToolComponentProps) {
  ...
  return (
    <div className="flex flex-col gap-3 p-4">
      <div className="flex flex-wrap items-center gap-2">
        <Button size="sm" onClick={handleUnflatten} disabled={!input.trim()}>
          Unflatten
        </Button>
      ...
      <SplitPane
        left={<CodeEditor value={input} onChange={resetInput} placeholder="Paste flat JSON here…" height="420px" />}
        right={
